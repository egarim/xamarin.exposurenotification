...
using XAF.ExposureNotification.Blazor.Server.Services;

namespace XAF.ExposureNotification.Blazor.Server {
    public partial class ExposureNotificationBlazorApplication : BlazorApplication {
        #region Default XAF configuration options (https://www.devexpress.com/kb=T501418)
        static ExposureNotificationBlazorApplication() {
            DevExpress.Persistent.Base.PasswordCryptographer.EnableRfc2898 = true;
            DevExpress.Persistent.Base.PasswordCryptographer.SupportLegacySha512 = false;
            DevExpress.ExpressApp.BaseObjectSpace.ThrowExceptionForNotRegisteredEntityType = true;
        }
        #endregion
        public ExposureNotificationBlazorApplication() {
            InitializeComponent();
            SetupAuthentication();
        ...
        private void ExposureNotificationBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
