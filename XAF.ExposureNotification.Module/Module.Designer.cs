...
namespace XAF.ExposureNotification.Module {
	partial class ExposureNotificationModule {
		/// <summary> 
		...
		private void InitializeComponent() {
			...
			this.AdditionalExportedTypes.Add(typeof(DbDiagnosis));
			this.AdditionalExportedTypes.Add(typeof(DbTemporaryExposureKey));
